...
describe('Экспедиция на Марс', () => {
  ...
  describe('Выбор ракеты', () => {
    ...
    it('позволяет выбрать ракету с максимальной дальностью полёта', () => {
      ...
      expect(rocket).toBe(rockets[2]);
      // под ракетой подразумевается строка с полным описанием ракеты
      // (например "Колумбия, межзвездная, 1209"),
      // разбитая на массив вида ['Колумбия', 'межзвездная', '1209']
    });
  });
});
